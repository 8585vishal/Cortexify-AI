...
// Fix: Update Icon components to accept all standard SVG props
...
export const ShrinkIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M15 9h6v6" /><path d="M9 15H3v-6" /><path d="M21 3l-7 7" /><path d="M3 21l7-7" />
    </svg>
);

export const ExpandIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M3 15v6h6" /><path d="M21 9V3h-6" /><path d="M3 21l7-7" /><path d="M14 14l7 7" />
    </svg>
);

export const SparklesIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="m12 3-1.9 1.9-3.2 1.4-1.4 3.2L3 12l1.9 1.9 1.4 3.2 3.2 1.4L12 21l1.9-1.9 3.2-1.4 1.4-3.2L21 12l-1.9-1.9-1.4-3.2-3.2-1.4Z" />
        <path d="M12 8.5v7" />
        <path d="M8.5 12h7" />
    </svg>
);
...
export const BrainIcon: React.FC<IconProps> = (props) => (
    <svg 
        ...
        {...props}
    >
        <path d="M9.5 2A2.5 2.5 0 0 1 12 4.5v1.2a1 1 0 0 0 1 1h.3a1 1 0 0 1 .9.7 1 1 0 0 0 1.6.3l.5-.5a2.5 2.5 0 1 1 3.5 3.5l-.5.5a1 1 0 0 0-.3 1.6 1 1 0 0 1-.7.9h-.3a1 1 0 0 0-1 1v1.2A2.5 2.5 0 0 1 14.5 22h-5A2.5 2.5 0 0 1 7 19.5v-1.2a1 1 0 0 0-1-1h-.3a1 1 0 0 1-.9-.7 1 1 0 0 0-1.6-.3l-.5.5a2.5 2.5 0 1 1-3.5-3.5l.5-.5a1 1 0 0 0 .3-1.6 1 1 0 0 1 .7-.9h.3a1 1 0 0 0 1-1V4.5A2.5 2.5 0 0 1 9.5 2z" />
    </svg>
);
