    ...
    <section id="about" className="py-20 bg-gray-900 border-t border-gray-800 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-3 text-white tracking-tight">Meet the Minds Behind CORTEXIFY</h2>
        </div>

        <div className="max-w-6xl mx-auto">
            <div className="bg-gray-800/40 backdrop-blur-md rounded-2xl p-8 md:p-12 border border-gray-700/50 hover:border-teal-500/30 transition-all duration-500 hover:shadow-[0_0_40px_rgba(20,184,166,0.1)] relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 justify-items-center">
                        {teamMembers.map((member, index) => (
                            <div key={index} className="group w-full max-w-xs bg-gray-900/60 p-6 rounded-xl border border-gray-700/50 hover:border-teal-500/50 hover:bg-gray-800 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl text-center flex flex-col items-center">
                                <div className="w-20 h-20 mb-4 rounded-full bg-gradient-to-br from-gray-700 to-gray-800 border-2 border-gray-600 group-hover:border-teal-400 flex items-center justify-center shadow-lg transition-colors duration-300">
                                     <span className="text-2xl font-bold text-gray-300 group-hover:text-white">
                                        {member.name.charAt(0)}
                                     </span>
                                </div>
                                <h3 className="text-lg font-bold text-white mb-2 group-hover:text-teal-300 transition-colors whitespace-normal break-words">{member.name}</h3>
